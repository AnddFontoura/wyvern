...
<body>
            ...
            <ul class="nav nav-pills">
                <li class="nav-item shoppingCartButton"> 
                    <a href="{{ url('cart') }}" class="btn btn-primary  position-relative"> 
                        {{ __('basic.site.shopping_cart') }} 
                        <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger shoppingCartAmount">
                            0
    ...
    <script src="{{ asset('bootstrap/js/cart.js') }}"></script>
